...
const UpdateClientPropect = ({ openSidebarToggle, OpenSidebar }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put(`http://127.0.0.1:8000/api/${clientid}/update_clientP/`, {
                nom,
                prenom,
                email,
                telephone,
            ...
            alert("Prospect modifié avec success");
        } catch (error) {
            console.error(error);
        }
    };
        ...
        <div className='grid-container'>
            ...
            <main className='main-container'>
                ...
                <div className='containerD'>
                        <header>Modifier le  Propect</header>
                        <div className='card-body'>
                            <form onSubmit={handleSubmit}>
                                <div className='form'>
                                    <div className='details'>
                                        <span className='title'>Modifier le Propect</span>
                                    </div>
                                    ...
                                    <div className='submit'>
                                        <button type='submit'>Enregistrer le Propect</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
export default UpdateClientPropect